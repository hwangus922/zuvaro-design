// Zuvaro v2 — black + hot pink + magenta + ORANGE.
// Tokens, logo (faithful recreation of the figma mark), icons.
...
const Z = {
  ...
  // ORANGE — the "loot / fire / pts" color
  orange:    '#FF6A2C',
  orangeLt:  '#FFB347',
  orangeDk:  '#C84A12',
  ...
  inkOnWarm: '#0A0508',   // always-dark text used on warm-gradient surfaces
  auraScale: 1,           // dark mode: full strength aura
  sheetOverlay: 'linear-gradient(180deg, rgba(10,10,12,0.4) 0%, rgba(10,10,12,0.7) 50%, #0A0A0C 75%)',
...
function ZMark({ size = 64, gradient = true, color = Z.pink, stroke = 7 }) {
